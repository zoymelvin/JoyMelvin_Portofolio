...
const projectData = {
  ...
  githubUrl: "https://github.com/zoymelvin/BookEat",
  gallery: [
    "/projects/bookeat/bookeat1.jpg",
    "/projects/bookeat/bookeat2.jpg",
    "/projects/bookeat/bookeat3.jpg",
    "/projects/bookeat/bookeat4.jpg",
  ],
  galleryCaptions: [
    "Halaman bagi pelanggan untuk memilih menu yang tersedia.",
    "Pelanggan dapat memilih meja yang kosong sesuai denah.",
    "Dasbor pemilik restoran untuk memantau pesanan yang sedang diproses.",
    "Riwayat transaksi dan pesanan yang telah selesai.",
  ],
  goal:
  ...
  challenge: {
    title: "Sinkronisasi Status Meja secara Real-Time",
    problem:
  ...
  prevProject: { name: "GadjahDjaya POS", slug: "gadjahdjaya" },
